...
//for(b in c)f.hasOwnProperty(b)||(f[b]=c[b])}return f},inherits:function(f,a){var d=f.prototype,c=p.makeInstance(a.prototype);p.extend(c,d,!0);f.prototype=c;return c.constructor=f},bind:function(f,a){return function(){return f.apply(a,arguments)}},defer:function(f,a,d){var c;return function(){d&&clearTimeout(c);c=setTimeout(f,a)}},indexOffunction(f,a,d){var c=-1;d=this.isNumber(d)?d:0;this.each(f,function(b,h){if(h>=d&&b===a)return c=h,!1});return c},removeItem:function(f,a){for(var d=0,c=f.length;d<
